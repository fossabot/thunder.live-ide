        ...
        return {
            Literal(node) {
                ...
                if (typeof node.value === 'number' &&
                    isParentTSClassProperty(node)) {
                    if (options.ignoreClassProperties) {
                        return;
                    }
 ...
 * @private
 */
function isParentTSClassProperty(node) {
    const parent = getLiteralParent(node);
    if ((parent === null || parent === void 0 ? void 0 : parent.type) === experimental_utils_1.AST_NODE_TYPES.ClassProperty) {
        return true;
    }
    return false;
}
